...
int main()
{
    ...
    // Load image.
    Mat frame;
    frame = imread("C:/medtro/sample.jpg");

    //Check if the sample directory is correct.
    if ( frame.size() == Size(0,0) ){
        cout << "The sample directory is not correct. Please make sure to specify the full directory. "  << endl;
        return EXIT_FAILURE;
    }
